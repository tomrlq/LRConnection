#
#  Be sure to run `pod spec lint LRConnection.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Ruan Lingqi"
  # s.authors            = { "Ruan Lingqi" => "tomrlq@foxmail.com" }
  # s.social_media_url   = "http://twitter.com/Ruan Lingqi"
